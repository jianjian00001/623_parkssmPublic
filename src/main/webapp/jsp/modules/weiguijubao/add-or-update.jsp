		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑违规举报</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>违规举报管理</span></li>
								<li class="breadcrumb-item active"><span>编辑违规举报</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">违规举报信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>举报内容</label>
										<textarea name="jubaoneirong" class="form-control" id="jubaoneirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>举报时间</label>
										<div id="jubaoshijianDate" class="input-append date form_datetime">
											<input id="jubaoshijian-input" name="jubaoshijian" size="20" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "weiguijubao/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("weiguijubao/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("weiguijubao/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#jubaoshijianDate").datetimepicker({ 
				autoclose: true,
		...
		function dataBind(){
			...
			$("#jubaoneirong").val(ruleForm.jubaoneirong);
			$("#jubaoshijian-input").val(ruleForm.jubaoshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jubaoneirong != null && res.data.jubaoneirong != ''){

					$("#jubaoneirong").val(res.data.jubaoneirong);
					}
					if(res.data != null && res.data != '' && res.data.jubaoshijian != null && res.data.jubaoshijian != ''){

					$("#jubaoshijian-input").val(res.data.jubaoshijian);
					$('#jubaoshijianFileName').val(res.data.jubaoshijian)
					}
