...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">违规举报管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>违规举报列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">违规举报列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>举报内容</th>
											<th onclick="sort('jubaoshijian')">举报时间<i id="jubaoshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var jubaoneirongCell  = document.createElement('td');

						  if(item.jubaoneirong != null && item.jubaoneirong != "" && item.jubaoneirong.length >= 11){
			  	jubaoneirongCell.innerHTML = item.jubaoneirong.substring(0, 10) + "..."; 
			  }else{
			  	jubaoneirongCell.innerHTML = item.jubaoneirong;
			  }


			row.appendChild(jubaoneirongCell);
			var jubaoshijianCell  = document.createElement('td');

						  jubaoshijianCell.innerHTML = item.jubaoshijian;


			row.appendChild(jubaoshijianCell);
		...
		function sh(){
			...
			httpJson("weiguijubao/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("weiguijubao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"weiguijubao");
