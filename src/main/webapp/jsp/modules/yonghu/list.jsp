...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="chepaihaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('chepaihao')">车牌号<i id="chepaihaoIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function search(){
			...
			if($('#chepaihaoSearch').val() != null && $('#chepaihaoSearch').val() != ''){
				searchForm.chepaihao ="%" +  $('#chepaihaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("yonghu/page","GET",{
				...
				chepaihao : searchForm.chepaihao,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var chepaihaoCell  = document.createElement('td');

						 chepaihaoCell.innerHTML = item.chepaihao;


			row.appendChild(chepaihaoCell);
