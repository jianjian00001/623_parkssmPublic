...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="jubaoshijian" name="jubaoshijian" class="form-control" v-model="ruleForm.jubaoshijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>用户名</label>
									...
									<div class="form-group  col-md-12">
										<label>举报内容</label>
										<script id="jubaoneirongEditor" type="text/plain" style="width:800px;height:230px;"></script>
										<script type="text/javascript">
										    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
										   //相见文档配置属于你自己的编译器
										 var jubaoneirongUe = UE.getEditor('jubaoneirongEditor', {
											toolbars: [
													[
														'undo', //撤销
														'bold', //加粗
										...
										<input type="hidden" name="jubaoneirong" id="jubaoneirong-input">
									</div>
									<div class="form-group  col-md-12">
										<label>审核回复</label>
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
			if(ruleForm.jubaoneirong != null && ruleForm.jubaoneirong != 'null' && ruleForm.jubaoneirong != ''){
				var mes = '' + ruleForm.jubaoneirong;
				var jubaoneirongUeditor = UE.getEditor('jubaoneirongEditor');
				jubaoneirongUeditor.ready(function() {
					jubaoneirongUeditor.setContent(mes);
					jubaoneirongUeditor.setDisabled('fullscreen');
				});
			}
